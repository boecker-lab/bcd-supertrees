package phylo.tree.algorithm.flipcut.mincut.cutGraphImpl.maxFlowGoldbergTarjan;/*
...
public class GoldbergTarjanCutGraphTest {
    ...
    public void multiThreadingTest(){
        ...
        File file = new File(getClass().getResource("/phylo/tree/algorithm/flipcut/sm.9.sourceTrees_OptSCM-Rooting.tre").getFile());
