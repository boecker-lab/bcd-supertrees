...
//            assertEquals(0, rfdist);
    ...
    public void bcdNoGuideTests() {
        FlipCutSingleCutSimpleWeight fs = new FlipCutSingleCutSimpleWeight(new SingleCutGraphCutter.Factory(CutGraphTypes.HYPERGRAPH_MINCUT_VIA_MAXFLOW_TARJAN_GOLDBERG));
        ...
        fcm = new FlipCutMultiCut(MultiCutGrapCutterFactories.newInstance(MultiCutGrapCutterFactories.MultiCutterType.VAZIRANI, CutGraphTypes.HYPERGRAPH_MINCUT_VIA_MAXFLOW_TARJAN_GOLDBERG));
        ...
        fcm = new FlipCutMultiCut(MultiCutGrapCutterFactories.newInstance(MultiCutGrapCutterFactories.MultiCutterType.GREEDY, CutGraphTypes.HYPERGRAPH_MINCUT_VIA_MAXFLOW_TARJAN_GOLDBERG));
        fcm.setNumberOfCuts(1);
        fcm.setWeights(FlipCutWeights.Weights.EDGE_WEIGHTS);
        fcm.setInput(TreeUtils.cloneTrees(TreeUtils.cloneTrees(source)));
        calculateSupertrees(fcm, exp);
        ...
        fcm = new FlipCutMultiCut(MultiCutGrapCutterFactories.newInstance(MultiCutGrapCutterFactories.MultiCutterType.GREEDY_RAND, CutGraphTypes.HYPERGRAPH_MINCUT_VIA_MAXFLOW_TARJAN_GOLDBERG));
        fcm.setNumberOfCuts(k);
        fcm.setWeights(FlipCutWeights.Weights.EDGE_WEIGHTS);
        fcm.setInput(TreeUtils.cloneTrees(TreeUtils.cloneTrees(source)));
        calculateSupertrees(fcm, exp);
