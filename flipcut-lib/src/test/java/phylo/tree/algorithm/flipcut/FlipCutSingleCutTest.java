...
public class FlipCutSingleCutTest {
...
//            Newick.getTreeFromString("((b,d),(x,y,z));"),
   ...
   /* @Parameterized.Parameter(2)
    ...
    public List<Tree> calculateSupertrees(TreeAlgorithm fs, Tree expected, Tree guide) {
        fs.run();
        Tree supertree = (Tree) fs.getResult();
    ...
    public void bcdNoGuideTests() {
        ...
        FlipCutGraphSimpleWeight g = new FlipCutGraphSimpleWeight(SimpleCosts.newCostComputer(TreeUtils.cloneTrees(TreeUtils.cloneTrees(source)), FlipCutWeights.Weights.UNIT_COST));
        fs.setInput(g);
...
//        FlipCutSingleCut fs = new FlipCutSingleCut(new SingleCutGraphCutter.Factory(CutGraphTypes.HYPERGRAPH_MINCUT_VIA_MAXFLOW_TARJAN_GOLDBERG));
    ...
    public void testMalteExample() {
        *//*
        ...
        FlipCutSingleCut fs = new FlipCutSingleCut(SingleCutGraphCutter.CutGraphTypes.MAXFLOW_TARJAN_GOLDBERG);
...
//        FlipCutSingleCut a = new FlipCutSingleCut(SingleCutGraphCutter.CutGraphTypes.MAXFLOW_TARJAN_GOLDBERG);
        FlipCutSingleCut a = new FlipCutSingleCut(new SingleCutGraphCutter.Factory(CutGraphTypes.HYPERGRAPH_MINCUT_VIA_MAXFLOW_TARJAN_GOLDBERG));
        long t = System.currentTimeMillis();

        a.setInput(new FlipCutGraphSimpleWeight(SimpleCosts.newCostComputer(
                Arrays.asList(trees[0], trees[1]),
                FlipCutWeights.Weights.EDGE_AND_LEVEL)));
        a.run();
