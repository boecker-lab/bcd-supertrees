...
//        FlipCutSingleCutSimpleWeight a = new FlipCutSingleCutSimpleWeight(SingleCutGraphCutter.CutGraphTypes.MAXFLOW_TARJAN_GOLDBERG);
        FlipCutSingleCutSimpleWeight a = new FlipCutSingleCutSimpleWeight(new SingleCutGraphCutter.Factory(SimpleCutGraphCutter.CutGraphTypes.HYPERGRAPH_MINCUT_VIA_MAXFLOW_TARJAN_GOLDBERG));
