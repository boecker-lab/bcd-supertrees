...
import flipCutGraph.AbstractFlipCutGraph;
import flipCutGraph.AbstractFlipCutNode;
import flipCutGraph.CutGraphCutter;
 ...
 * Time: 14:42
 */
public abstract class AbstractFlipCutSingleCut<N extends AbstractFlipCutNode<N>, T extends AbstractFlipCutGraph<N>, C extends CutGraphCutter<N,T>> extends AbstractFilpCut<N,T> {
    private static final boolean CALCULATE_SCORE = true;

    public DebugInfo debugInfo;
    private long globalWeight;
    protected final C cutter;

    public AbstractFlipCutSingleCut(SingleCutGraphCutter.CutGraphTypes type) {
        super();
        cutter = getCutter(type);
    }
...
//                        }
    ...
    protected abstract C getCutter(CutGraphCutter.CutGraphTypes type);
