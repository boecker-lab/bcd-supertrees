...
import costComputer.CostComputer;
import costComputer.FlipCutWeights;
import costComputer.UnitCostComputer;
import costComputer.WeightCostComputer;
 ...
 * Time: 13:56
 */
public class FlipCutMultiCut extends AbstractFilpCut<FlipCutNodeSimpleWeight,FlipCutGraphMultiSimpleWeight> {
    ...
    @Override
    protected FlipCutGraphMultiSimpleWeight createInitGraph(CostComputer costsComputer, double bootstrapThreshold) {
