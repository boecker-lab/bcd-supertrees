...
public abstract class AbstractFlipCutGraph<T extends AbstractFlipCutNode<T>> {
    ...
    protected AbstractFlipCutGraph(CostComputer costs, double bootstrapThreshold){
        ...
        /*
       Sort the leaves alphabetically to ensure we find the same cuts
       for multiple runs
        */
        sortTaxa();
    }
    ...
    /*
       Sorts the leaves alphabetically to ensure we find the same cuts
       for multiple runs
     */
    ...
    protected abstract List<List<T>> createGraphData(CostComputer costs, double bootstrapThreshold);
